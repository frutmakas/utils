 ...
 * $Name:  $
 * $Author: syed $
 * $Date: 2004/04/05 18:40:16 $
 * $Revision: 1.1.2.2 $
 * $Id: stbcofdmldpc.cpp,v 1.1.2.2 2004/04/05 18:40:16 syed Exp $
 *******************************************************************/
...
int main() {
	const int nb_user=1, nb_user_max=2, nb_porteuse=128, nb_frame=50; 
...
#endif
for(filter_length=1;filter_length<3;filter_length+=2) {
    int frame_size=1;
...
//		int sptr = 0;
		...
		ZMatrix rx2(nb_porteuse, nb_user_max), rxu2(nb_porteuse, nb_user_max);//,	rx2=0;
